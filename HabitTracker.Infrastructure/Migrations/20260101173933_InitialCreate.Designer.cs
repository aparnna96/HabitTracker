...
namespace HabitTracker.Infrastructure.Migrations
{
    ...
    [Migration("20260101173933_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.HabitLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.Category", b =>
                {
                    b.HasOne("HabitTracker.Core.Entities.ApplicationUser", "User")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.Habit", b =>
                {
                    b.HasOne("HabitTracker.Core.Entities.Category", "Category")
                        .WithMany("Habits")
            ...
            modelBuilder.Entity("HabitTracker.Core.Entities.HabitLog", b =>
                {
                    b.HasOne("HabitTracker.Core.Entities.Habit", "Habit")
                        .WithMany("HabitLogs")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HabitTracker.Core.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
